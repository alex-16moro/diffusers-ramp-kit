...
|---|---|---|---|
| acceptance | PASS | 4.757s | [acceptance log](runs/20260923T100746995936Z/acceptance.log) |
| scheduler-tests | PASS | 6.737s | [scheduler-tests log](runs/20260923T100746995936Z/scheduler-tests.log) |
| lint | PASS | 0.028s | [lint log](runs/20260923T100746995936Z/lint.log) |
| format | PASS | 0.026s | [format log](runs/20260923T100746995936Z/format.log) |
| upstream-quality | PASS | 6.632s | [upstream-quality log](runs/20260923T100746995936Z/upstream-quality.log) |
| copies | PASS | 1.393s | [copies log](runs/20260923T100746995936Z/copies.log) |
| dummies | PASS | 0.025s | [dummies log](runs/20260923T100746995936Z/dummies.log) |
| support-list | PASS | 0.019s | [support-list log](runs/20260923T100746995936Z/support-list.log) |
| forward-docstrings | PASS | 2.745s | [forward-docstrings log](runs/20260923T100746995936Z/forward-docstrings.log) |
| dependency-table | PASS | 0.135s | [dependency-table log](runs/20260923T100746995936Z/dependency-table.log) |
| dependencies | PASS | 4.827s | [dependencies log](runs/20260923T100746995936Z/dependencies.log) |
| test-strength | PASS | 4.787s | [test-strength log](runs/20260923T100746995936Z/test-strength.log) |
